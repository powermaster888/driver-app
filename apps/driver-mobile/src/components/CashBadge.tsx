...
export function CashBadge({ method, amount }: { method: string; amount: number }) {
  ...
  return (
    <XStack backgroundColor={bg} paddingHorizontal={8} paddingVertical={3} borderRadius="$2" alignItems="center" gap={4} accessibilityLabel={`Cash collection required: ${method} ${amount} dollars`} accessibilityRole="text">
